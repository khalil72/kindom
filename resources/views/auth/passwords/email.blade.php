        ...
        <div class="row">
            <div class="form-holder">
                <div class="col-md-12  text-center mt-5 mt-md-5 mb-5 mb-md-5 pt-2 pt-md-4" >
                    <img src="{{ asset('assets/media/logos/kingdom-logo-png.png') }}" alt="logo"  class='logo-img'>
                </div>
                    ...
                    <div class="form-items">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="form-button mt-3">
                                <button id="submit" type="submit" class="btn btn-primary w-100">Proceed</button>
                            </div>

                            <a href="{{ route('login') }}" class="w-100 btn-md my-2 btn btn-warning"> Back to Login</a>
                        </form>
                    </div>
                </div>
            </div>
